...
namespace API_PROYECTO_ONG.Controllers
{
    ...
    public class MetodoPagoesController : ControllerBase
    {
        ...
        {
            if (id != metodoPago.idmetodo_pago)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<MetodoPago>> PostMetodoPago(MetodoPago metodoPago)
        {
            ...
            return CreatedAtAction("GetMetodoPago", new { id = metodoPago.idmetodo_pago }, metodoPago);
        }
        ...
        {
            return _context.MetodosPago.Any(e => e.idmetodo_pago == id);
        }
    }
}
