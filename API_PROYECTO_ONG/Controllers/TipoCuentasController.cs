...
namespace API_PROYECTO_ONG.Controllers
{
    ...
    public class TipoCuentasController : ControllerBase
    {
        ...
        {
            if (id != tipoCuenta.idtipo_cuenta)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<TipoCuenta>> PostTipoCuenta(TipoCuenta tipoCuenta)
        {
            ...
            return CreatedAtAction("GetTipoCuenta", new { id = tipoCuenta.idtipo_cuenta }, tipoCuenta);
        }
        ...
        {
            return _context.TiposCuenta.Any(e => e.idtipo_cuenta == id);
        }
    }
}
