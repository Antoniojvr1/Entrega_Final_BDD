...
namespace API_PROYECTO_ONG.Controllers
{
    ...
    public class RolUsuariosController : ControllerBase
    {
        ...
        public RolUsuariosController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<RolUsuario>> PostRolUsuario(RolUsuario rolUsuario)
        {
            ...
            {
                if (RolUsuarioExists(rolUsuario.idrol))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetRolUsuario", new { id = rolUsuario.idrol }, rolUsuario);
        }
        ...
        {
            return _context.RolUsuarios.Any(e => e.idrol == id);
        }
    }
}
